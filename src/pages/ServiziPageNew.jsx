...
const ServiceCard = ({ service, isExpanded, onToggle }) => {
  ...
  return (
    <article 
      id={service.id} 
      className={`service-card-new ${isExpanded ? 'expanded' : ''} ${service.featured ? 'featured' : ''}`}
    >
...
const ServiziPageNew = () => {
  ...
  return (
    <PageTransition>
      ...
      <section className="services-page-new">
