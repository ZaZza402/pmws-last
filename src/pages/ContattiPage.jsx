...
const contactOptions = [
  {
    icon: <FaWhatsapp />,
    title: 'WhatsApp',
    description: 'Perfetto per una domanda veloce o per inviarci una foto di un documento.',
    action: <a href="https://wa.me/390612345678?text=Buongiorno" target="_blank" rel="noopener noreferrer">Invia un Messaggio</a>
  },
  {
    icon: <FaPhoneAlt />,
    title: 'Telefono',
    description: 'Se preferisci parlare direttamente con noi per spiegarci la tua situazione.',
    action: <a href="tel:+390612345678">Chiama Ora</a>
  },
  {
    icon: <FaEnvelope />,
    title: 'Email',
    description: "Ideale per richieste più dettagliate o se hai bisogno di allegare più file.",
    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <p>Hai un dubbio o vuoi semplicemente capire come possiamo aiutarti? Non esitare a contattarci. Una chiacchierata non costa nulla e può risolvere molti problemi.</p>

          <div className="panel mt-4">
            <div className="contact-grid">
              <div>
                <h3 style={{ margin: '0 0 .5rem' }}>Contattaci Come Preferisci</h3>
                <div className="contact-timeline mt-2">
                  {contactOptions.map((option, idx) => (
                    <div className="contact-step" key={option.title}>
                      <span className="contact-step-icon" aria-hidden="true">{option.icon}</span>
              ...
              <div>
                ...
                <address className="mt-2" style={{ fontStyle: 'normal' }}>
                  <strong>PuntoMigrare</strong><br />
                  Via del Fuoco Sacro, 97<br />
                  00133 Roma RM
                </address>
                <div id="mapLoader" className="mt-2" style={{ position: 'relative', aspectRatio: '16/9', border: '1px solid var(--border)', borderRadius: '18px', overflow: 'hidden', background: 'var(--card)' }}>
                  <iframe
