...
const DocumentSection = () => {
  return (
    <section id="documenti" className="section booking" aria-labelledby="documents-title">
      <div className="container">
        <div style={{ textAlign: 'center' }}>
          ...
          <p className="mt-2" style={{ maxWidth: '65ch', margin: '0.5rem auto 0 auto' }}>
            Scopri quali documenti servono per la tua pratica di immigrazione e dove trovarci per ricevere assistenza specializzata.
          </p>
        </div>
        ...
        <div className="panel mt-4">
          <div className="contact-grid">
            ...
            <div>
              ...
              <p className="mt-1" style={{minHeight: '48px'}}>Seleziona la tua pratica e scopri esattamente quali documenti preparare per velocizzare la procedura.</p>
            ...
            <div id="contatti-info">
              <h3 style={{ margin: '0 0 .5rem' }} id="mappa">2. Vieni a Trovarci</h3>
