...
const FaqSection = () => {
  ...
  return (
    <section id="faq-preview" className="section" aria-labelledby="faq-title">
      <div className="container">
        <div style={{ textAlign: 'center' }}>
          <h2 id="faq-title">Domande Comuni, Risposte Chiare</h2>
          <p className="mt-2" style={{ maxWidth: '65ch', margin: '0.5rem auto 0 auto' }}>
            Sappiamo che hai molti dubbi. Qui trovi le risposte alle domande più frequenti che riceviamo ogni giorno.
          </p>
        </div>
